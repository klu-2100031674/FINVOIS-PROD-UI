...
const SbiDashboardPage = () => {
  const templates = useMemo(() => getTemplatesForExecutiveRole('sbi_executive'), []);
    ...
    <ClientLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 font-manrope">SBI Verification Templates</h1>
            <p className="text-sm text-gray-500 mt-1">
              Select an SBI verification template to fill the form and generate a PDF report.
            </p>
          </div>
          {sbiLogoUrl && (
...
export default SbiDashboardPage;
