...
const BoiReportsPage = () => (
  <ClientLayout>
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-gray-900 font-manrope">BOI Reports</h1>
          <p className="text-sm text-gray-500 mt-1">View and download PDF reports you have generated.</p>
        </div>
        <Link
          to="/executive/boi/dashboard"
