...
const CompanyUserSidebar = ({
  ...
  const navItems = [
    { to: '/company/user/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    // { to: '/company/user/theory-pages', icon: BookOpen, label: 'Theory Pages' },
    ...
    { to: '/company/user/reports', icon: FileStack, label: 'My reports' },
    { to: '/company/user/profile', icon: User, label: 'Profile' },
  ];
            ...
            {navItems.map((item) => (
              <li key={`${item.to}-${item.label}`}>
                <NavLink
                  to={item.to}
                  className={linkClass}
                  end={item.to === '/company/user/dashboard'}
                >
