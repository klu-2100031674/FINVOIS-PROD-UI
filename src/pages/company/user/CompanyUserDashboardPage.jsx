...
/**
 * Company-affiliated user home (`/company/user/dashboard`) — isolated from retail `/dashboard`.
 */
const CompanyUserDashboardPage = () => {
...
export default CompanyUserDashboardPage;
