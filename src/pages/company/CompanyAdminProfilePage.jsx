/**
 * Company admin profile — company_admin role only (see App routing).
 */
...
const CompanyAdminProfilePage = () => {
  ...
  const companyName = user?.company_name || 'Not assigned';

  return (
    <AdminLayout>
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800">Company admin profile</h1>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-900 px-6 py-8">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                <h2 className="text-2xl font-bold">{user?.name || 'Company Admin'}</h2>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mt-6">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-xl border border-purple-200 bg-purple-50 p-4">
              ...
              <p className="text-2xl font-bold text-purple-800 mt-2">{freeCredits}</p>
              <p className="text-xs text-purple-700 mt-1">Available to share with your company users</p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <p className="text-sm font-semibold text-gray-900 mt-2 truncate" title={companyName}>
                {companyName}
              </p>
            </div>
