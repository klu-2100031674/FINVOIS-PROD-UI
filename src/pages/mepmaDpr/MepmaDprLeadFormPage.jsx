...
import {
  MEPMA_DPR_SCHEMES,
  MEPMA_DPR_GENDER_OPTIONS,
  MEPMA_DPR_LOAN_TYPE_OPTIONS,
  MEPMA_DPR_RURAL_URBAN_OPTIONS,
  MEPMA_DPR_ENTERPRISE_TYPE_OPTIONS,
  MEPMA_DPR_SECTOR_OPTIONS,
  MEPMA_DPR_ASSET_CATEGORIES,
        ...
        <div className="lg:col-span-3 bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 text-sm text-gray-600 font-['Inter'] space-y-1">
              ...
              <li>MEPMA applicants and urban enterprises</li>
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div className="flex items-center gap-2">
              <label htmlFor="mepma-dpr-language" className="text-sm font-medium text-gray-600">
                {copy.languageLabel}
              </label>
              <select
                id="mepma-dpr-language"
                value={language}
          ...
          {step === 'done' ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mb-2">{copy.successBody}</p>
              <p className="text-gray-500 mb-6 text-sm">
                Your customer account has been created. Log in later with WhatsApp OTP on this mobile number to view your reports.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <FormField label={copy.loanType} required>
                ...
                >
                  ...
                  {MEPMA_DPR_LOAN_TYPE_OPTIONS.map((opt) => (
              ...
              <FormField label={copy.gender} required>
                ...
                >
                  ...
                  {MEPMA_DPR_GENDER_OPTIONS.map((opt) => (
                    <option key={opt} value={opt}>
              ...
              <FormField label={copy.sector} required>
                ...
                >
                  ...
                  {MEPMA_DPR_SECTOR_OPTIONS.map((opt) => (
                    <option key={opt} value={opt}>
              ...
              <FormField label={copy.enterpriseType} required>
                ...
                >
                  ...
                  {MEPMA_DPR_ENTERPRISE_TYPE_OPTIONS.map((opt) => (
                    <option key={opt} value={opt}>
              ...
              {!isGoldLoan && (
                <FormField label={copy.ruralUrbanCategory} required>
                  ...
                  >
                    ...
                    {MEPMA_DPR_RURAL_URBAN_OPTIONS.map((opt) => (
                      <option key={opt} value={opt}>
                                ...
                                <tr key={idx} className="hover:bg-gray-50/50">
                                  ...
                                  <td className="p-2">
                                    ...
                                    >
                                      ...
                                      {MEPMA_DPR_ASSET_CATEGORIES.map((cat) => (
...
export default MepmaDprLeadFormPage;
