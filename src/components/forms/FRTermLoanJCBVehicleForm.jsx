...
const JCB_SECTOR_LABEL = 'service sector without stock';

const FRTermLoanJCBVehicleForm = ({
  onSubmit,
  initialData = {},
  isEditMode = false,
  reportId = null,
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <select
            value={(formData['General Information'] && formData['General Information']['i14']) || JCB_SECTOR_LABEL}
          ...
          >
            <option value={JCB_SECTOR_LABEL}>{JCB_SECTOR_LABEL}</option>
          </select>
        </div>
        <div className="space-y-1.5">
          <label className="block text-xs font-semibold text-gray-800">
    ...
    <div style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl shadow-soft p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm">JCB Vehicle</p>
        </div>
...
export default FRTermLoanJCBVehicleForm;
