...
const ASSET_SECTIONS_DEFAULT = {
  'Commercial Vehicle': { start: 185, end: 194, loanCell: 'k35' },
};
...
const OTHER_EV_SECTOR_LABEL = 'service sector without stock';

const FRTermLoanOtherThanEVVehicleForm = ({
  onSubmit,
  initialData = {},
  isEditMode = false,
  reportId = null,
  ...
  const [formData, setFormData] = useState(() => {
    const ensureSector = (gi) => {
      ...
      return { ...gi, i14: presetSector || OTHER_EV_SECTOR_LABEL };
    };
    ...
    base['General Information'].i14 = presetSector || OTHER_EV_SECTOR_LABEL;
    return base;
  });
  ...
  const requiredFields = {
    ...
    'Schedule for Assets': [],
    'Schedule for Indirect Expenses': [],
    'Vehicle Expense': ['e299', 'e300', 'e301', 'e302'],
  };
  ...
  const fillTestData = useCallback(() => {
    ...
    const scheduleForAssets = {
        'd185': 'Commercial Truck', 'e185': 18.5,
    };
    ...
    setFormData({
      'General Information': {
        ...
        'i12': 35,
        'i13': 'Male',
        'i14': presetSector || OTHER_EV_SECTOR_LABEL,
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <select
            value={(formData['General Information'] && formData['General Information']['i14']) || OTHER_EV_SECTOR_LABEL}
          ...
          >
            <option value={OTHER_EV_SECTOR_LABEL}>{OTHER_EV_SECTOR_LABEL}</option>
          </select>
        </div>
        <div className="space-y-1.5">
          <label className="block text-xs font-semibold text-gray-800">
      ...
      <div className="space-y-6">
        <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-[#7e22ce]">
            Enter Commercial Vehicle details for the project cost.
          </p>
    ...
    <div style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="bg-white rounded-xl shadow-soft p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm">Commercial Vehicle — Other Than EV</p>
        </div>
...
export default FRTermLoanOtherThanEVVehicleForm;
