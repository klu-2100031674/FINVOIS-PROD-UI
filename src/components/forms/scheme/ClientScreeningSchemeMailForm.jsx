...
import {
  TOPIC_OPTIONS,
  optionNameForMail,
} from './clientScreeningSchemeMailConstants';
 ...
 */
const ClientScreeningSchemeMailForm = ({
  supportSource = 'ui:client-screening-public',
}) => {
  ...
  const showNameHint =
    fullName.length > 0 && nameLetterCount < NAME_MIN_LETTERS;
  ...
  const handleSubmit = async (e) => {
    ...
    setIsSending(true);
    try {
      await api.post('/support/client-screening', {
...
export default ClientScreeningSchemeMailForm;
