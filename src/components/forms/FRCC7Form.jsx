...
const FRCC7Form = ({
  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'h15', label: 'Working Capital Loan Interest %',                            type: 'number', min: 0, max: 100, step: 0.01,        required: true },
        { id: 'h16', label: 'Processing Fees (%)',                                        type: 'number', min: 0,          step: 0.01,         required: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'i38', label: 'Electricity/Power Expense',                                   type: 'number', min: 0,  required: true },
        { id: 'i39', label: 'Depreciation',                                                type: 'number', min: 0,  required: true },
        { id: 'i40', label: 'Rent/Lease Expenses',                                         type: 'number', min: 0,  required: true },
        { id: 'i41', label: 'Salaries & Wages',                                            type: 'number', min: 0,  required: true },
        { id: 'i42', label: 'Processing fees',                                             type: 'number', min: 0,  required: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'h78', label: 'Processing Fees Rate (%)',                          type: 'number', min: 0, step: 0.01, required: true },
    ...
    },
    {
      ...
      icon: UserIcon,
      fields: [
        { id: 'i159',        label: 'Partner Name 1',              type: 'text', required: true  },
        { id: 'i160',        label: 'Partner Name 2',              type: 'text', required: false },
        { id: 'i161',        label: 'Address',                     type: 'text', required: true  },
        { id: 'i162',        label: 'Mobile Number',               type: 'text', required: true  },
  ...
  const renderAssetSection = (section, activeTab, setActiveTab) => {
    ...
    const firstYear = formData['Financial Years']?.['i20'] || '';
    const secondYear = formData['Financial Years']?.['i21'] || '';
    const netTotal = formData['Financial Statements']?.['i54'] || 0;
