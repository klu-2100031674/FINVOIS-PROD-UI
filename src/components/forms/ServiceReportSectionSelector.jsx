...
import { normalizeStage2Snapshot } from '../../utils/draftPayload';
...
const SECTION_CONFIG = [
  ...
  },
  {
    ...
    title: "14. Inventory / Stock Details",
  ...
  },
  {
    ...
    title: "19. Justification of Land Requirements",
  ...
  },
  {
    ...
    title: "20. Implementation Timeline",
...
const SKIP_VALIDATION_SECTIONS = new Set([
  'swot_analysis',                    // 7
  'target_market_new',                // 8
  'competitor_overview',              // 9
  'market_trend',                     // 10
  'conclusion'                        // 21
]);

const ServiceReportSectionSelector = ({
  onBack,
  onSubmit,
  initialData = {},
  onStage2Change,
        ...
        if (currentValue === undefined || currentValue === '' || currentValue === null || (Array.isArray(currentValue) && currentValue.length === 0)) {
          if (field.name === 'promoters') {
            ...
            testData[section.id][field.name] = field.options[0];
             ...
             else if (field.name === 'location_name') testData[section.id][field.name] = "Mangalagiri";
             else if (field.name === 'district') testData[section.id][field.name] = "Vijayawada";
             else if (field.name === 'state') testData[section.id][field.name] = "Andhra Pradesh";
             else if (field.name === 'nearest_city') testData[section.id][field.name] = "Vijayawada";
...
export default ServiceReportSectionSelector;
