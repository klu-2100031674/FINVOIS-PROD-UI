...
export const FORM_COPY = {
  en: {
    ...
    placeholderLoanAmount: 'e.g. ₹25,00,000',
  ...
  te: {
    ...
    district: 'జిల్లా',
    description: 'వివరణ',
    otherInfoRequired: 'డిపిఆర్ తయారీకి అవసరమైన ఇతర సమాచారం:',
    otherInfoRequiredSub: 'ఆటోమేటెడ్ డిపిఆర్ రూపకల్పన కోసం ఆస్తి వివరాలు మరియు రుణ నిబంధనలను అందించండి.',
    assetModel: 'ఆస్తి మోడల్',
    assetCategory: 'ఆస్తి వర్గం',
    selectAssetCategory: 'వర్గం ఎంచుకోండి',
    amount: 'మొత్తం (₹)',
    loanPercentage: 'రుణ శాతం (%)',
    addRow: '+ ఆస్తిని జోడించండి',
    removeRow: 'తొలగించు',
    noAssetsAdded: 'ఇంకా ఆస్తులు జోడించబడలేదు. పైన ఉన్న "+ ఆస్తిని జోడించండి" నొక్కండి.',
    loanTermPeriod: 'రుణ కాలపరిమితి',
    ...
    placeholderLoanAmount: 'ఉదా. ₹25,00,000',
